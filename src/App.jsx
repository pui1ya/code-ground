 ...
 * App.jsx
 * --------------------------------------------------------------------
 * CodeSync application root.
 *
 * Responsibilities
 * ----------------
 * • Creates the application's routing tree.
 * • Wraps the entire application in AuthProvider.
 * • Protects authenticated pages using PrivateRoute.
 * • Redirects signed-in users away from Login/Register.
 * • Shows a loading screen while the initial auth session is verified.
 *
...
/* Public Route
 *
 * Prevents authenticated users from returning to Login/Register.
 * ------------------------------------------------------------------ */
